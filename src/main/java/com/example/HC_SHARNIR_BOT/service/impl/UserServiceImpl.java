...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(MessageServiceImpl messageService, UserRepository userRepository, List<User> users) {
    ...
    public void registerUser(Message msg) {
        if (userRepository.findById(msg.getChatId()).isPresent()) {
            ...
            messageService.prepareAndSendMessage(msg.getChatId(), msg.getText());
            ...
            msg.setText("Отлично, добавил тебя в список участников зимнего сезона, удачи Чемпион" + ":muscle:");
            messageService.prepareAndSendMessage(msg.getChatId(), msg.getText());
